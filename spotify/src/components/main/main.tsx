...
const playLists = [
    {
        url: 'https://fakeimg.pl/600/365314/fff?text=Cover&font=lobster',
...
const Main = () => {
    return (
        <main className="text-white relative">
            <div className="h-[275px] bg-gradient-to-b from-[#1f1f1f] to-[#121212] absolute w-full"/>
                           ...
                           className="relative p-4 rounded-md bg-[#181818] hover:bg-[#272727] duration-200 group">
                            <div className="relative">
                                <img src="https://fakeimg.pl/600/7f1d1d/fff?text=Cover&font=lobster"
                                     className="rounded shadow-lg" alt="img"/>
                                <button
                            ...
                            <h3 className="mt-4 mb-1 font-semibold tracking-wide capitalize">Playlist
                                title</h3>
